...
public class FileUtil {
    ...
    public static boolean existDir(String dirPath) {
        File file = new File(dirPath);
        return file.isDirectory();
    }

    public static void judgeFileExist(String filePath) throws FileNotFoundException {
        if (!existFile(filePath)) {
            throw new FileNotFoundException(filePath);
        }
    }

    public static void judgeDirExist(String dirPath) throws FileNotFoundException {
        if (!existDir(dirPath)) {
